...
#ao final do projeto colocar definições de DB e servidor de email neste arquivo
#import local_settings.py

#Em local_settings.py estão as definições do Banco de Dados e do servidor de email
from django2.local_settings import *
